...
function buildVolumeMounts(
  ...
  if (fs.existsSync(envFile)) {
    ...
    const allowedVars = ['ANTHROPIC_API_KEY', 'BRAVE_API_KEY', 'GH_TOKEN', 'NOTION_API_KEY', 'GOG_KEYRING_PASSWORD', 'GOG_ACCOUNT', 'HA_URL', 'HA_TOKEN', 'FRESHRSS_URL', 'FRESHRSS_API_KEY'];
