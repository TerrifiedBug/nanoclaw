...
2. Copy channel plugin files into place:
   ...
   cp -r .claude/skills/channels/whatsapp/files/* plugins/channels/whatsapp/
   ```
...
Follow the WhatsApp authentication flow described in `.claude/skills/channels/whatsapp/SKILL.md`.
...
After authentication, use `/add-channel` to register a WhatsApp group or DM.
